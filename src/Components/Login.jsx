...
export default function Login() {
  ...
  const onClick = async (e) => {
    ...
    try {
      const data = await authServices(dataTosend)
...
>
  <MuiAlert severity="error" elevation={6} variant="filled"  >User Name Or Password Not Correct !</MuiAlert>
</Snackbar>
  
  const isSucssesLogin = 
  <Snackbar
  anchorOrigin={{vertical:'bottom', horizontal:'center' }}
  open={succses}
  //onClose={handleClose}
  //key={vertical + horizontal}
>
  <MuiAlert severity="success" elevation={6} variant="filled"  >Login Succsesfuly !</MuiAlert>
</Snackbar>
